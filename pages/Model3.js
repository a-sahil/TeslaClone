...
const Model3 = () => {
  ...
  return (
    <div>
      ...
      <img src="https://static-assets.tesla.com/configurator/compositor?context=design_studio_2&options=$MT351,$PN01,$W38A,$IPB2&view=STUD_FRONT34&model=m3&size=1920&bkba_opt=2&crop=0,0,0,0&" alt="bg-img" className="fixed" />
      </div>
  ...
  <div className="absolute top-28 right-12 text-center ">
    <h1 className="text-4xl font-semibold px-2 py-6">Model 3</h1>
    <div>
      <div className="flex flex-row justify-between">
      <p className="text-2xl  font-sans font-semibold text-[#393C41] pl-4">272 <span className="text-base">mi</span></p>
      <p className="text-2xl  font-sans font-semibold text-[#393C41] pl-6">125 <span className="text-base">mph</span></p>
      <p className="text-2xl  font-sans font-semibold text-[#393C41] pl-3">5.8 <span className="text-base">sec</span></p>
      </div>
  ...
  <hr className="border-t-2 border-black" />
      ...
      <div className="relative top-[500px]">
       ...
       <div>
        ...
        <p className="font-semibold mb-3">18’’ Photon Wheels<span className="text-gray-500"> Included </span></p>
        <p className="text-gray-500 text-sm mb-2">All-Season Tires</p>
        <p className="text-gray-500 text-sm mb-2">Range (EPA est.) : 272mi</p>
       ...
       <div>
        ...
        <button className="text-sm text-[#393C41] bg-gray-100 px-7 py-1 rounded hover:bg-[#eeeff1] transition delay-200 duration-200 ease-in-out mb-32">Feature Detail</button>
       </div>
...
<button className="bg-[#F4F4F4] text-[#393C41] text-sm border px-8 py-1 rounded  hover:bg-[#eeeff1] transition delay-200 duration-200 ease-in-out">Learn More</button>
   ...
   <div className="mb-44">
    <h1 className="text-3xl mb-4 font-semibold">Order Your Model 3</h1>
    <p className="mb-6 text-[#393C41] font-bold">Est. Delivery: Apr – May 2024</p>
